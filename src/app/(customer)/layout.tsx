...
export default function RootLayout({ children }: PropsWithChildren) {
  ...
  const isDashboardRoute = isCustomerRoute;
  ...
  const navItems = isCustomerRoute ? customerNavItems : publicNavItems;
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              {!user ? (
                <>
                  ...
                  <Link
                    href="/register"
                    className="px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 hover:shadow-lg hover:shadow-cyan-500/50 transition-all"
                  >
                    Register
                  </Link>
                </>
          ...
          <div className="grid gap-12 md:grid-cols-3 items-center">
            ...
            <div className="text-center md:text-left space-y-2">
              ...
              <p className="text-sm font-medium text-gray-400">
                Software Engineer <span className="text-cyan-500/50">/</span>{" "}
